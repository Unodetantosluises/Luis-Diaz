        ...
        <HeaderStyled theme={theme}>
            ...
            <div className="left-header">
                <div className="left-h-content">
                    <h2>Hola,</h2>
                    <h1>Soy Luis Diaz<span>.</span></h1>
                    <p className="profession">Diseñador UX</p>
                    <p className='description'>
                    Me apasiona resolver problemas complejos y crear soluciones que sean estéticamenteagradables y funcionales. Que algo sea dificil no es motivo para no hacerlo, es razon para seguir intentandolo.
                    </p>
